...
public class PlayableChessBoard 
{
	...
	//Useful if we need to undo:
	private MoveableGamePiece lastPieceCaptured;
	...
	public String toString() 
	{
		return "PlayableChessBoard [player=" + player + ", checkmate=" + checkmate + ", startOfMove=" + startOfMove
				...
				+ blackKingsSquare + ", validMove=" + validMove + "]";
	}
	...
	private boolean moveIsBlocked(Position startingSquare, Position destination)
	{
		...
		//Knights can jump over pieces on intermediate squares.
...
//		}
	 ...
	 * @precondition isValidMove has returned true for the proposed move. 
	...
	private void executeMove(Position startingSquare, Position destination)
	{
		...
		pieces[destination.getRow()][destination.getColumn()] = 
				pieces[startingSquare.getRow()][startingSquare.getColumn()];
